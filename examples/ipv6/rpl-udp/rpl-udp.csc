...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>48.89721689503849</x>
        <y>46.13828707912099</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>26.186490141134627</x>
        <y>88.55530962468349</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.3712880211333975 0.0 0.0 3.3712880211333975 26.435598943330135 23.727272727272766</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
&#xD;
 TIMEOUT(99999999); // Set to infinity (disable timeout)&#xD;
&#xD;
 // Set simulation parameters&#xD;
 var sim_time = 20*60*1000; // Simulation time h*m*s*ms&#xD;
...
&#xD;
 ...
 var output = new FileWriter("/home/user/logs/log_"+ today +".csv");&#xD;
&#xD;
 // Creater header&#xD;
...
&#xD;
 // Ouput script total sum (last line) for xls&#xD;
 output.write("SUM");&#xD;
 var column = 'B';&#xD;
...
&#xD;
 ...
 log.testOK();   // End script with success</script>
      <active>false</active>
    </plugin_config>
    <width>600</width>
    <z>0</z>
